...
const breadcrumbs = [
    ...
    { text: 'Thêm nhà cung cấp', url: route('suppliers.create') }
];
</script>
<template>
    <Head title="Thêm mới nhà cung cấp" />

    <AuthenticatedLayout>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 ">
            <BreadcrumbsVue :breadcrumbs="breadcrumbs" />
            <h1 class="font-medium text-base">Thêm nhà cung cấp</h1>
            <div class="mt-6 max-w-5xl mx-auto border p-3 rounded">
                <form @submit.prevent="form.post(route('suppliers.store'))">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div class="mt-2">
                            ...
                            <TextInput id="phone" type="text" class="mt-1 block w-full border px-3 py-2" v-model="form.phone"
