...
const updatePassword = () => {
    form.put(route('customer.password.update'), {
        preserveScroll: true,
...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Cập nhật mật khẩu</h2>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <InputLabel for="current_password" value="Mật khẩu cũ" />
